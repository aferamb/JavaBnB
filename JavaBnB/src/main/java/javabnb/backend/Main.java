...
public class Main {
   ...
   TarjetaCredito Tarjeta1 = new TarjetaCredito("pepe",12345678912340567L,LocalDate.of(2024, 5, 19));
   ...
   Reserva reserva = new Reserva (inm1,Tarjeta1,per1,LocalDate.of(2024, 3, 12),LocalDate.of(2024, 3, 15));
