 ...
 * @author ALEJANDRO
 */
public class ConsultarReservasAdministrador extends javax.swing.JFrame {
     ...
     * @param persona
     */
    public ConsultarReservasAdministrador( Point localizacion) {
        this.setLocation(localizacion);
        this.anfitrion = (Anfitrion) anfitrion;
        this.listaReservas =GestorInmueble.getReservas();
    ...
    private void initComponents() {
        ...
        buscarGestionarInmuebles.setText("Consultar inmuebles");
        ...
        btnReseñaModInm.setText("Consultar usuarios");
    ...
    private void buscarGestionarInmueblesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarGestionarInmueblesActionPerformed
        BuscarInmueblesAdministrador inmuadmin = new BuscarInmueblesAdministrador(this.getLocation());
        inmuadmin.setVisible(true);
        this.dispose();
    ...
    private void AmpliarInmueble1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AmpliarInmueble1ActionPerformed
        ...
        if (!titulo1.getText().equals("")){
            MostrarReservaAdministrador mostrarReserva = new MostrarReservaAdministrador(this.getLocation(),reserva1);
